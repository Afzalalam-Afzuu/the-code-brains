...
import { Wrench, Calendar, QrCode, Image as ImageIcon, Code2, Database, ArrowRight, Home, Orbit, Terminal } from "lucide-react";

export default function ToolsNavbar() {
  const pathname = usePathname();

  const toolLinks = [
    { name: "API Workbench", href: "/tools/api-playground", icon: Terminal },
